...
- [[Training Supervision]]—How they are guided during training
- [[Batch vs. Online Learning]]—Whether or not they can learn incrementally on the fly
- [[Instance-Based vs. Model-Based Learning]]—Whether they work by simply comparing new data points to known data points, or instead by detecting patterns in the training data and building a predictive model
