...
To find the $\boldsymbol{\theta}$ that minimizes the MSE, there's a **closed-form solution** — a formula that gives the result directly, without using [[Gradient Decent]]:
$$
