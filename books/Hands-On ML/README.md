...
- **Part I, The Fundamentals of Machine Learning**
	...
	- How to train and evaluate models for a variety of tasks using [Scikit-Learn](https://scikit-learn.org/stable/).
- **Part II, Neural Networks and Deep Learning**
	- What neural networks are, how they work, and how to build and train deep learning models using [PyTorch](https://pytorch.org/).
