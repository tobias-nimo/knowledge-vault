...
The system learns a model from the training data by **identifying patterns and relationships in the data**, then uses the learned model to make predictions on new instances. Common examples are linear regression and Support Vector Machines (SVMs).  #model-based-learning
