...
# array([ 0, 4, 5, 6, 7, 8, 10, 11, [...], 995, 997, 998, 999])
...
It's easy to implement yourself — for example, train a #k-nearest-neighbors classifier on the core instances: 
...
![[8-14.png]]
> Decision boundary between the two clusters (the crosses are the four new instances).
